 ...
 * outside of the DeleteDebtCommand code. For example, inputs "1" and "1 abc" take the
 * same path through the DeleteDebtCommand, and therefore we test only one of them.
...
public class DeleteDebtCommandParserTest {
    ...
    public void parse_validArgs_returnsDeleteCommand() {
        assertParseSuccess(parser, "1", new DeleteDebtCommand(INDEX_FIRST_DEBT));
    }
