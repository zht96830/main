...
public class TestApp extends MainApp {
    ...
    public TestApp(Supplier<ReadOnlyFinanceTracker> initialDataSupplier, Path saveFileLocation) {
        ...
        if (initialDataSupplier.get() != null) {
            JsonFinanceTrackerStorage jsonAddressBookStorage = new JsonFinanceTrackerStorage(saveFileLocation);
            try {
                jsonAddressBookStorage.saveFinanceTracker(initialDataSupplier.get());
     ...
     */
    public FinanceTracker readStorageAddressBook() {
        try {
