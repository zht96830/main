...
public class JsonAdaptedExpenseTest {
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        JsonAdaptedExpense expense = new JsonAdaptedExpense(null, VALID_AMOUNT, VALID_DATE, VALID_CATEGORY, VALID_REMARKS);
    ...
    public void toModelType_nullAmount_throwsIllegalValueException() {
        JsonAdaptedExpense expense = new JsonAdaptedExpense(VALID_NAME, null, VALID_DATE, VALID_CATEGORY, VALID_REMARKS);
    ...
    public void toModelType_nullCategory_throwsIllegalValueException() {
        JsonAdaptedExpense expense = new JsonAdaptedExpense(VALID_NAME, VALID_AMOUNT, VALID_DATE, null, VALID_REMARKS);
