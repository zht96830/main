...
public class TypicalIndexes {
    ...
    public static final Index INDEX_FIRST_RECURRING = Index.fromOneBased(1);
    public static final Index INDEX_SECOND_RECURRING = Index.fromOneBased(2);
    public static final Index INDEX_THIRD_RECURRING = Index.fromOneBased(3);
}
