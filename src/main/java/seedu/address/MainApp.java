...
import seedu.address.storage.FinanceTrackerStorage;
...
public class MainApp extends Application {
    ...
    public void init() throws Exception {
        logger.info("=============================[ Initializing FinanceTracker ]===========================");
        super.init();
    ...
    private Model initModelManager(Storage storage, ReadOnlyUserPrefs userPrefs) {
        ...
        try {
            ...
            initialData = financeTrackerOptional.orElseGet(SampleDataUtil::getSampleAddressBook);
    ...
    public void start(Stage primaryStage) {
        logger.info("Starting FinanceTracker " + MainApp.VERSION);
