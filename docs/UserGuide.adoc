...
* `addBudget c/total $/12000 sd/1-1-2019 ed/31-12-2019`
...
* `editBudget c/total ed/31-3-2019`
* `editBudget c/total $/5000 sd/1-1-2019 ed/31-3-2019`
...
`Please enter the category (optional): shopping` +
...
* INDEX of a specific expense can be viewed in the debt list.
...
Examples:
`editDebt 5` +
`Please enter the updated name of the person you owed: Tommy` +
`Please enter the updated amount owed: 60.00` +
...
=== List debts: `listDebt`
List all the debts with the option of sorting it by their deadlines.

Format: `listDebt [v/DEADLINE]`

* Debts with nearest deadlines will be shown first. Debts without deadlines will be at the bottom of the list.
...
Delete the debt record at specified INDEX.
...
e.g. `editBudget c/total $/5000 sd/1-1-2019 ed/31-3-2019`
