...
The Recurring feature consists of `addrecurring`, `editrecurring`, `listrecurring`, `deleterecurring` `clearrecurring`, and `convertrecurringtoexpense`. +
...
The purpose of this feature is to provide the convenience for users by adding outstanding expenses from all their recurring expenses into the expense list. After adding recurring expenses into the Finance Tracker, th
