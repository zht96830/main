...
This feature allows users to add recurring expenses: expenses that are perioidic and have a fixed frequency and a defined number of occurrences. Examples of these 'recurring' are bills or subscription fees.
