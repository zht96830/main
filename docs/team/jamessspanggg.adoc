...
* *Code contributed*: [https://nus-cs2103-ay1819s2.github.io/cs2103-dashboard/#search=jamessspanggg[Code collated by reposense]]
...
*** Refactored `Person` classes from AddressBook4 to `Expense` classes (Pull Request https://github.com/CS2103-AY1819S2-W15-2/main/pull/174[#174])
*** Updated `ExpenseList` to always be sorted in descending order of date (Pull Request https://github.com/CS2103-AY1819S2-W15-2/main/pull/174[#174])
